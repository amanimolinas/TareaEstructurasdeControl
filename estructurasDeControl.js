...
function imprimirPares(numero) {
    ...
    // Bucle que recorre desde 0 hasta el número
...
function detenerEnSeis() {
    for (let i = 1; i <= 10; i++) {
        if (i === 6) {
            break; // Detiene el bucle cuando el número es 6
        }
        console.log(i);
    }
}
...
function saltarCinco() {
    for (let i = 1; i <= 10; i++) {
        if (i === 5) {
            continue; // Salta la iteración cuando el número es 5
        }
        console.log(i);
    }
}
...
function obtenerDiaSemana(dia) {
    ...
    switch (dia) {
        ...
        case 7:
            ...
            break;
        default:
            console.log("Número no válido. Ingresa un número entre 1 y 7.");
        break;
    }
}
